package org.homepage.course.service.impl;
...
//        throw new RuntimeException("Error");
    ...
    private CourseInfo buildCourseInfo(HomepageCourse course) {
    	...
    	return new CourseInfo(course.getId(), course.getCourseName(), course.getCourseType() == 0 ? "免费课程" : "实战课程",
    			course.getCourseIcon(), course.getCourseIntro());
